...
Select file(s) you want to delete
Press Delete key OR right-click and select "Delete"
Enter your password in the prompt
Click "OK" to proceed with deletion or "Cancel" to abort
Permanent Deletion
Select file(s) you want to permanently delete
Press Shift+Delete
Enter your password when prompted
File(s) will be permanently deleted (bypassing Recycle Bin)
Changing Your Password
Press Alt+S or right-click tray icon → Settings
Enter your current password
Enter and confirm your new password
Click "Save"
Adjusting Grace Periods
Open Settings (Alt+S)
Select desired Keyboard Grace Period (10-25 seconds)
Recommended: 20-25 seconds for comfortable batch operations
Select desired Context Menu Grace Period (2-7 seconds)
...
Press Alt+P OR right-click tray icon → "Pause/Resume Protection"
Protection is now disabled (tray icon changes)
Delete files normally without password prompts
Press Alt+P again to resume protection
...
Alt+S
Settings
Open settings panel to change password and grace periods
Alt+X
Exit
Close Delete Protector completely
Delete
Protected Delete
Intercepts Delete key, requires password
Shift+Delete
Protected Permanent Delete
Intercepts Shift+Delete, requires password
...
Recommended Value
Reason
Context Menu Grace Period
2-3 seconds ⭐
Provides real-time protection while giving enough time to interact with the delete dialog
Keyboard Grace Period
20-25 seconds
Comfortable for batch deletions via keyboard
Password
